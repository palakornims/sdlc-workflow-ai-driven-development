...
**Agent:** `product-owner` (`.claude/agents/product-owner.md`). Invoke it with the raw
...
**Agent:** `solution-architect` (`.claude/agents/solution-architect.md`). It refuses to start
...
**Agent:** `project-manager` (`.claude/agents/project-manager.md`). It refuses to start without
...
**Agent:** `dotnet-developer` (`.claude/agents/dotnet-developer.md`). The backend is .NET / C#.
...
**Agent:** `code-reviewer` (`.claude/agents/code-reviewer.md`). Review-only; never edits code and
...
`.claude/agents/playwright-test-planner.md`, `playwright-test-generator.md`, and
...
**Agent:** `qa-engineer` (`.claude/agents/qa-engineer.md`), a principal QA engineer. It prepares
...
**Agent:** `product-owner` (`.claude/agents/product-owner.md`) in validation mode. The same
