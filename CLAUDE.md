...
This repo follows the six-phase workflow in `WORKFLOW.md`. **Plan, Design, and Breakdown MUST
...
- `solution-architect` (`.claude/agents/solution-architect.md`): runs the Design phase. Requires
...
- `project-manager` (`.claude/agents/project-manager.md`): runs the Breakdown phase. Requires
...
- `dotnet-developer` (`.claude/agents/dotnet-developer.md`): runs the Implement phase. One
...
- `code-reviewer` (`.claude/agents/code-reviewer.md`): runs the Code Review phase. Review-only.
...
- `qa-engineer` (`.claude/agents/qa-engineer.md`): principal QA engineer for the Test phase.
