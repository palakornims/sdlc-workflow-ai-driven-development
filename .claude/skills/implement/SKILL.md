...
2. Invoke the `dotnet-developer` subagent (`subagent_type: "dotnet-developer"`).
...
5. Tell the user the task is ready for `/review $ARGUMENTS`, which will pass the rescue output
